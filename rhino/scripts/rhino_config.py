"""RHINO Strategy — Shared config, MCP helpers, state I/O."""
...
CONFIG_PATH = SKILL_DIR / "config" / "rhino-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("RHINO_WALLET", "")
    strategy_id = os.environ.get("RHINO_STRATEGY_ID", "")
