"""VIPER Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "viper-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "viper-config.json"
...
def get_wallet_and_strategy():
    ...
    strategy_id = os.environ.get("VIPER_STRATEGY_ID", "")
