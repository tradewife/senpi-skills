"""VIXEN Strategy — Shared config, MCP helpers, state I/O.
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "vixen-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "vixen-config.json"
STATE_DIR = SKILL_DIR / "state"
HISTORY_FILE = os.path.join(WORKSPACE, "vixen-emerging-history.json")
...
def get_wallet_and_strategy():
    wallet = os.environ.get("VIXEN_WALLET", "")
    strategy_id = os.environ.get("VIXEN_STRATEGY_ID", "")
