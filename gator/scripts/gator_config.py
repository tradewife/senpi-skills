"""GATOR Strategy — Shared config, MCP helpers, state I/O."""
...
SKILL_DIR = Path(WORKSPACE) / "skills" / "gator-strategy"
CONFIG_PATH = SKILL_DIR / "config" / "gator-config.json"
...
def get_wallet_and_strategy():
    wallet = os.environ.get("GATOR_WALLET", "")
    strategy_id = os.environ.get("GATOR_STRATEGY_ID", "")
